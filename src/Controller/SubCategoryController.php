...
final class SubCategoryController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash('success', 'La sous-catégorie à bien été crée');
    ...
    #[Route('/show/{id}', name: 'app_sub_category_show', methods: ['GET'])]
    ...
    #[Route('/edit/{id}', name: 'app_sub_category_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/delete/{id}', name: 'app_sub_category_delete', methods: ['POST'])]
    public function delete(Request $request, SubCategory $subCategory, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$subCategory->getId(), $request->getPayload()->getString('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('danger', 'La sous-catégorie à bien été supprimée');
        }
